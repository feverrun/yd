...
const shanyi_token = process.env.SHANYI_TOKEN ? process.env.SHANYI_TOKEN : ''
const shanyi_u = process.env.SHANYI_U ? process.env.SHANYI_U : ''
const shanyi_client = 'android'
const shanyi_ua = 'shanyi/2.4.0(android;PCCM00;10)/72c72761cd514fc8a9f80a17321c3c35'
