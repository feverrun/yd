...
#loon
http-request \/score_task\/v1\/task\/(sign_in|get_read_bonus) script-path=jrtt.js, requires-body=true, timeout=10, tag=今日头条极速版sign
http-request \/ttgame\/game_farm\/home_info script-path=jrtt.js, requires-body=true, timeout=10, tag=今日头条极速版farm
cron "5,35 8-23 * * *" script-path=jrtt.js, tag=今日头条极速版
*/
