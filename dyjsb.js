...
#loon
http-request /luckycat/aweme/v1/task/sign_in/detail? script-path=dyjsb.js, requires-body=true, timeout=10, tag=抖音极速版sign

http-request /luckycat/aweme/v1/task/done/read? script-path=dyjsb.js, requires-body=true, timeout=10, tag=抖音极速版read

http-request /luckycat/aweme/v1/task/walk/step_submit? script-path=dyjsb.js, requires-body=true, timeout=10, tag=抖音极速版step
...
function invitation() {
    return new Promise((resolve, reject) => {
        let invitatonurl ={
            ...
            headers: JSON.parse(readkey),
            body: JSON.stringify({"in_sp_time":0,"invite_code":""})
        }
